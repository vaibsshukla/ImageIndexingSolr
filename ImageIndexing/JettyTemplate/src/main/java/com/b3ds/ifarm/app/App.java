...
public class App {
    ...
    private static LoadProperties props = LoadProperties.loadProperties();
    
    public static void main(String[] args) throws Exception {
    	
    /*	System.out.println(props.getProperty("solr.core"));   
    	System.out.println(props.getProperty("hdfs.url"));
